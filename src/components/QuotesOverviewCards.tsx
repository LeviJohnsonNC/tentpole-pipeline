      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-2">
        ...
        <Card className="bg-white border border-gray-200">
          <CardContent className="p-2">
            ...
            <div className="space-y-1">
              <div 
                className={`flex items-center justify-between cursor-pointer hover:bg-gray-50 p-0.5 rounded ${
        ...
        <Card className="bg-white border border-gray-200">
          <CardContent className="p-2">
            ...
            <p className="text-xs text-gray-500 mb-1">Past 30 days</p>
        ...
        <Card className="bg-white border border-gray-200">
          <CardContent className="p-2">
            <h3 className="text-sm font-medium text-gray-900 mb-1">How can I get paid faster?</h3>
            <p className="text-xs text-gray-600 mb-1.5">Jobber can help you take payments instantly in person or set up automatic payments.</p>
