...
const RequestSnapshot = ({ dealData, showConvertedPill = false }: RequestSnapshotProps) => {
  const { request, quote } = dealData;
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        ...
        {request.urgency && (
          <div>
            <div className="text-xs font-medium text-gray-700 mb-1">Urgency</div>
            <Badge 
